<?php
    ...
    $SQL = mysqli_query($conn,'SELECT radcheck.*,radusergroup.groupname FROM radcheck,radusergroup WHERE radcheck.username=radusergroup.username'.$con);
    if(isset($_POST['del'])){
        ...
        <div class="row">
            ...
            <div class="form-group form-inline">
              <input type="text"
                ...
                <a href="insertuser.php" class="btn btn-warning ml-2 text-white">เพิ่มผู้ใช้งาน</a>
                <a href="genuser.php" class="btn btn-success ml-2 text-white">เพิ่มผู้ใช้งานอัตโนมัติ</a>
            </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$rs['fullname']?></td>
                            <td><?=$rs['groupname']?></td>
                            <td><a class="btn btn-warning text-white" href="edituser.php?username=<?=$rs['username']?>">แก้ไข</a></td>
