    ...
    if(isset($_POST['save'])){
        ...
        if($nums==0){
            ...
            while($k>$x){
                ...
                $k-1;
                $lisa = 'INSERT INTO radcheck (username,attribute,op,value,fullname,pic) VALUE ("'.$name.'","Cleartext-Password",":="
                ,"'.$_POST['values'].'","'.$name.'","img/default.png")';
                $roses = 'INSERT INTO radusergroup (username,groupname,priority) VALUE ("'.$name.'","'.$_POST['groupname'].'",1)';
            ...
            <div class="col-md-5 mt-3">
                ...
                <div class="card mt-3">
                  ...
                  <input type="number"
                    ...
                    <small class="text-muted">เพิ่มผู้ใช้ครั้งได้ไม่เกิน 99 ID/ครั้ง</small>
                    <hr>
